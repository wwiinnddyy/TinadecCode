...
export const PROVIDER_TEMPLATES: ProviderTemplate[] = [
  {
    ...
    category: 'cloud-api',
    summary: 'Generic OpenAI Chat Completions API endpoint.',
  ...
  },
  {
    ...
    connection_kind: 'api-key',
    category: 'cloud-api',
    summary: 'Claude models via Anthropic Messages API.',
  ...
  },
  {
    ...
    connection_kind: 'api-key',
    category: 'cloud-api',
    summary: 'Gemini models via Google AI API.',
  ...
  },
  {
    ...
    connection_kind: 'api-key',
    category: 'cloud-api',
    summary: 'DeepSeek API with reasoning support.',
  ...
  },
  {
    ...
    connection_kind: 'api-key',
    category: 'cloud-api',
    summary: 'Unified gateway to 200+ models from multiple providers.',
  ...
  },
  {
    ...
    connection_kind: 'api-key',
    category: 'cloud-api',
    summary: 'Ultra-fast inference via Groq LPU hardware.',
  ...
  },
  {
    ...
    connection_kind: 'api-key',
    category: 'cloud-api',
    summary: 'Serverless open-source model hosting.',
  ...
  },
  {
    ...
    connection_kind: 'api-key',
    category: 'cloud-api',
    summary: 'Fast serverless inference for open-source models.',
  ...
  },
  {
    ...
    connection_kind: 'api-key',
    category: 'cloud-api',
    summary: 'Mistral AI models via La Plateforme API.',
  ...
  },
  {
    ...
    connection_kind: 'api-key',
    category: 'cloud-api',
    summary: 'Command R+ and embed models via Cohere API.',
  ...
  },
  {
    ...
    connection_kind: 'api-key',
    category: 'cloud-api',
    summary: 'Qwen models via Alibaba Cloud DashScope API.',
  ...
  },
  {
    ...
    connection_kind: 'api-key',
    category: 'cloud-api',
    summary: 'OpenAI models hosted on Microsoft Azure.',
  ...
  },
  {
    ...
    connection_kind: 'api-key',
    category: 'cloud-api',
    summary: 'Claude and other models via AWS Bedrock.',
  ...
  },
  {
    ...
    connection_kind: 'api-key',
    category: 'cloud-api',
    summary: 'GitHub Copilot models via Copilot API.',
  ...
  },
  {
    ...
    summary: 'Run open-source models locally via Ollama.',
  ...
  },
  {
    ...
    connection_kind: 'local-server',
    category: 'local-server',
    summary: 'High-throughput local/remote vLLM inference server.',
  ...
  },
  {
    ...
    connection_kind: 'local-server',
    category: 'local-server',
    summary: 'Fast local/remote SGLang inference server.',
  ...
  },
  {
    ...
    connection_kind: 'local-server',
    category: 'local-server',
    summary: 'Run models locally via LM Studio OpenAI-compatible server.',
  ...
  },
  {
    ...
    connection_kind: 'cli',
    category: 'agent-cli',
    summary: 'OpenAI Codex CLI agent runtime with sandboxed workspace.',
  ...
  },
  {
    ...
    connection_kind: 'cli',
    category: 'agent-cli',
    summary: 'Anthropic Claude CLI agent runtime.',
    default_base_url: null,
    default_model: 'claude-sonnet-4-6',
    capabilities: ['agent', 'cli', 'workspace'],
    brand_color: '#d97706',
  ...
  },
  {
    ...
    connection_kind: 'cli',
    category: 'agent-cli',
    summary: "Cursor Agent Communication Protocol runtime.",
    default_base_url: null,
    default_model: 'auto',
  ...
  },
  {
    ...
    connection_kind: 'cli',
    category: 'agent-cli',
    summary: 'OpenCode CLI/server hybrid runtime.',
  ...
  },
  {
    ...
    connection_kind: 'api-key',
    category: 'custom',
    summary: 'Connect to any OpenAI-compatible API endpoint.',
    default_base_url: '',
    default_model: '',
    capabilities: ['chat', 'streaming'],
    brand_color: '#8b949e',
